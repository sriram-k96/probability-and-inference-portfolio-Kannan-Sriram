...
ggplot(data = a1, aes(x = GameIndex, y = Profit)) + geom_bar(stat = "identity") + labs(title = "Average Earnings Simulation")
mean(a1$Profit)
...
ggplot(data = b1, aes(x = GameIndex, y = Profit)) + geom_bar(stat = "identity") + labs(title = "Average Earnings Simulation", xlab = "Profit", ylab = "Game Index")
mean(b1$Profit)
...
ggplot(data = c1, aes(x = GameIndex, y = Profit)) + geom_bar(stat = "identity") + labs(title = "Average Earnings Simulation")
mean(c1$Profit)
```
...
ggplot(data = d1, aes(x = GameIndex, y = Profit)) + geom_bar(stat = "identity") + labs(title = "Average Earnings Simulation")
mean(d1$Profit)
```
