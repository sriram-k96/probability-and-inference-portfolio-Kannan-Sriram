...
curve(
    pgamma(x, coef(fitgammagh)[1], coef(fitgammagh)[2])
  , add = TRUE
  , col = "blue"
  , lwd = 3
)
hist(gh, freq = FALSE, main = "PDF of Glycohemoglobin - Gamma Distribution")
curve(
    dgamma(x, coef(fitgammagh)[1], coef(fitgammagh)[2])
  , add = TRUE
  , col = "blue"
  , lwd = 3
)
...
curve(
    pgamma(x, coef(fitgammaht)[1], coef(fitgammaht)[2])
  , add = TRUE
  , col = "blue"
  , lwd = 3
)
hist(ht, freq = FALSE, main = "PDF of Height of Adult Females - Gamma Distribution")
curve(
    dgamma(x, coef(fitgammaht)[1], coef(fitgammaht)[2])
  , add = TRUE
  , col = "blue"
  , lwd = 3
)
...
qgammahtml <- qgamma(sq, shape = coef(fitgammaht)[1], scale = coef(fitgammaht)[2])
...
hist(gh, freq = FALSE, main = "PDF of Glycohemoglobin - Normal Distribution")
curve(
...
hist(ht, freq = FALSE, main = "PDF of Height of Adult Females - Normal Distribution")
curve(
...
fitweibullgh <- mle(
    wLLgh
  , start = list(scale= 6.017, shape = 10)
  , method = "L-BFGS-B"
  , lower = c(0, 0.01)
)
...
hist(gh, freq = FALSE, main = "PDF of Glycohemoglobin - Weibull Distribution")
curve(
...
fitweibullht <- mle(
    wLLht
  , start = list(scale = 163.98, shape = 27)
  , method = "L-BFGS-B"
  , lower = c(0, 0.01)
)
...
curve(
    pweibull(x, coef(fitweibullht)[1], coef(fitweibullht)[2])
  , add = TRUE
  , col = "blue"
  , lwd = 3
)
hist(ht, freq = FALSE, main = "PDF of Height of Adult Females - Weibull Distribution")
curve(
    dweibull(x, coef(fitweibullht)[1], coef(fitweibullht)[2])
  , add = TRUE
  , col = "blue"
  , lwd = 3
)
...
qweibullhtml <- qweibull(sq, shape = coef(fitweibullht)[1], scale = coef(fitweibullht)[2])
