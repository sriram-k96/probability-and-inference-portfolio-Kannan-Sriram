...
plot(tm,sm, xlab = "Theoretical quantile", ylab = "Sample quantile")
abline(0,1)
...
```
The functions dorder, porder and qorder are already generalized and can take a new parameter k for the kth order statistic and not just the median. 
